...
RSpec.describe Enumerable do
  describe '#my_all?' do
    ...
    it 'return true if is equal to all? method' do
      expect([13_123, nil, 431_321].my_all?(Integer)).to eql([13_123, nil, 431_321].all?(Integer))
    end
  ...
  describe '#my_any?' do
    ...
    it 'return true if is equal to any? method' do
      expect([13_123, nil, 431_321].my_any?(Integer)).to eql([13_123, nil, 431_321].any?(Integer))
    end
  ...
  describe '#my_none?' do
    ...
    it 'return true if is equal to none? method' do
      expect([13_123, nil, 431_321].my_none?(Integer)).to eql([13_123, nil, 431_321].none?(Integer))
    end
